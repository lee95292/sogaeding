...
<html>
	...
	<body>
		...
		<div class="content content_img" style="overflow: hidden;">
			<img src="/resources/imgs/background/signup-img.jpg" style="width:100%">
		</div>
					...
					<table class="write_tb mgt0">
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" id="name" class="w150 han" name="name">
								</td>
							</tr>
							<tr>
									...
									<td>
										<p class="groupId">
											* 4~12자의 영문소문자 또는 영문소문자 + 숫자를 입력해 주세요.
											<br><br>
											<input type="text" id="userId" name="userId" class="w160" style="ime-mode:disabled;" maxlength="12">
								...
								<tr>
									...
									<p class="passwordPolicyLi">
									    2. 아이디, 생년월일, 전화번호 등 개인정보와 관련된 숫자, 연속된 숫자, 반복된 문자 등 다른 사람이 쉽게 알아낼 수 있는 비밀번호는 개인정보 유출의 위험이 높으므로 사용하지 않는 것이 좋습니다.
											...
											<br>
											<input type="password" id="password" name="password" class="w160" maxlength="16" size="30">
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="repwd"><span>비밀번호 확인</span></label></th>
										<td><input type="password" id="repwd" class="w160" maxlength="16" size="30"> <span class="level" id="password_equal"></span></td>
									</tr>
									<tr>
										...
										<td>
											...
											<input type="text" id="subEmail1" name="subEmail1" class="w160" style="ime-mode:disabled;">@
											<input type="text" id="subEmail2" name="subEmail2" class="w160" style="ime-mode:disabled;">
